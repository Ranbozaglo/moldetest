...
**Backend**: https://moldetest-67e6.onrender.com
...
### 1. Health Check
```bash
curl https://moldetest-67e6.onrender.com/health
```

### 2. API Endpoints
```bash
# Test inspection endpoints
curl https://moldetest-67e6.onrender.com/api/inspection

# Test authentication
curl -X POST https://moldetest-67e6.onrender.com/api/auth/login \
