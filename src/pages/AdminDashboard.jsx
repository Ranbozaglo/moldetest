...
export const generateReportHtmlContent = async (inspection, samples) => {
    ...
    const css = `
        ...
        .finding-block { page-break-inside: avoid; break-inside: avoid-page; display: block; }
    ...
    if (inspection.app_id === 'asbestos') {
      ...
      <body>
          ...
          <div class="report-container findings-page">
    ...
    const visibleMoldHtml = inspection.mold_images && inspection.mold_images.length > 0 && moldLocations.length > 0
      ? moldLocations.map((location, i) => {
          ...
          return `<div class="keep-together finding-block" style="padding: 0 0 15px 0; margin-bottom: 15px;">
            ${i === 0 ? `<h3 style="color: #dc2626; font-size: 16px; margin: 0 0 12px 0;">Visible Mold Detected</h3>` : ''}
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px;">
              <h4 style="color: #004aac; font-weight: bold; margin: 0;">Location #${i + 1}: ${sanitizeReportText(location) || 'N/A'}</h4>
